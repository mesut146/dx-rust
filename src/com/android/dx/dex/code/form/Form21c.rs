...
let static THE_ONE: InsnFormat = Form21c::new();
struct Form21c{
}
impl Form21c{
    pub fn new(&self)    {
...
pub fn writeTo(&self, out: &AnnotatedOutput, insn: &DalvInsn){
    ...
    InsnFormat::write_AnnotatedOutput_short_short(&out, InsnFormat::opcodeUnit_DalvInsn_int(&insn, regs.get(0).getReg()), cpi as i16);
}
}
